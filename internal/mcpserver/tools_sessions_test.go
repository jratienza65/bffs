...
func TestListSessionsPendingRehomeAndLimit(t *testing.T) {
	...
	if imported.BundleID != catBundle || imported.OldCwd != oldCwd || imported.OldHost != "mac-a" || imported.OldHome != "/Users/dev" || imported.GitRemote != "git@github.com:x/bffs.git" {
...
func TestListMemories(t *testing.T) {
	...
	if !ok || !notes.Pinned || len(notes.AbsolutePaths) != 1 || notes.AbsolutePaths[0] != "/Users/dev/x" || notes.AtRefs == nil || notes.SizeBytes == 0 {
