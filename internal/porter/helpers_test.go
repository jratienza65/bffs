...
func exportOpts() ExportOptions {
	return ExportOptions{Version: "0.4.0", Account: store.Account{Name: "alice", Type: store.TypeOAuth}, Isolation: store.IsolationPartial, Now: fixedNow}
}
