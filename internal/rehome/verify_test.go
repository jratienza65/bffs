...
func TestVerifyCommand(t *testing.T) {
	cases := []struct {
		...
		{"/home/dev/src/bffs", testSID, "", "cd /home/dev/src/bffs && claude --resume " + testSID},
		{"/home/dev/src/bffs", testSID, "work", "BFFS_ACCOUNT=work cd /home/dev/src/bffs && claude --resume " + testSID},
		{"/Users/dev/My Projects/bffs", testSID, "", "cd '/Users/dev/My Projects/bffs' && claude --resume " + testSID},
		{"/tmp/it's here", testSID, "", `cd '/tmp/it'\''s here' && claude --resume ` + testSID},
		{"/tmp/a$b", testSID, "", "cd '/tmp/a$b' && claude --resume " + testSID},
		{"C:/Users/dev/src", testSID, "", "cd C:/Users/dev/src && claude --resume " + testSID},
