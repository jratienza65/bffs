...
func TestMemories(t *testing.T) {
	...
	if !reflect.DeepEqual(topic.AbsolutePaths, []string{"/home/dev/src"}) || !reflect.DeepEqual(topic.AtRefs, []string{"@~/.claude/extra.md"}) {
		t.Errorf("topic refs = abs %v at %v", topic.AbsolutePaths, topic.AtRefs)
	}
	if !reflect.DeepEqual(byName[MemoryIndexFile].AbsolutePaths, []string{"/Users/dev/build/x"}) {
		t.Errorf("index refs = %v", byName[MemoryIndexFile].AbsolutePaths)
	}
	if got := byName["logs/2026/08/24/0f3b2c1e-fix.md"].AbsolutePaths; !reflect.DeepEqual(got, []string{`C:\Users\dev\x`}) {
...
func TestScanAbsolutePaths(t *testing.T) {
	...
	want := []PathRef{
		{File: MemoryIndexFile, Line: 3, Path: "/Users/dev/build/x", Kind: PathKindAbs},
		{File: "logs/2026/08/24/0f3b2c1e-fix.md", Line: 1, Path: `C:\Users\dev\x`, Kind: PathKindAbs},
		{File: "topic.md", Line: 6, Path: "@~/.claude/extra.md", Kind: PathKindAt},
		{File: "topic.md", Line: 6, Path: "/home/dev/src", Kind: PathKindAbs},
		{File: "topic.md", Line: 6, Path: "/home/dev/src", Kind: PathKindAbs},
	}
...
func TestClassifyToken(t *testing.T) {
	cases := []struct {
		...
		{"/Users/dev/x", "/Users/dev/x", PathKindAbs, true},
		{"/home/d/x,", "/home/d/x", PathKindAbs, true},
