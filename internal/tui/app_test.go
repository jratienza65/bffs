...
func TestSessionsScreen(t *testing.T) {
	...
	wantAll(t, h.view(), "scan paths", "notes.md:4: /Users/dev/x", "@ref MEMORY.md:2: @~/notes.md", "3 references")
	h.keys("esc")
	if h.a.top() != s {
...
func TestMemoriesTab(t *testing.T) {
	...
	wantAll(t, h.view(), "notes.md:4: /Users/dev/x", "notes.md:4: /Users/dev/y", "@ref MEMORY.md:2: @~/notes.md")
	h.keys("esc", "esc")
	if _, ok := h.a.top().(*projectsScreen); !ok {
