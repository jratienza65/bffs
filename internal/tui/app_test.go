...
func (f *fixture) memory() string {
	...
	files := map[string]string{
		...
		"notes.md":                  "---\npinned: true\n---\nPaths: /Users/dev/x and /Users/dev/y\n",
	}
...
func TestWorkspaceSingleRoot(t *testing.T) {
	...
	wantAll(t, h.view(), "notes.md:4: /Users/dev/x", "@ref MEMORY.md:2: @~/notes.md", "3 references")
	h.keys("esc")
	h.keys("d")
...
func TestSessionsPanel(t *testing.T) {
	...
	wantAll(t, out, "prompt two", "imported·pending · 9d ago", "/home/nobody/src/x (missing here)",
		"import       bundle 6f1e2c0a-0000-4000-8000-000000000001", "from mac-a (dev, /Users/dev), account work, status pending",
...
func TestMemoryTab(t *testing.T) {
	...
	h.keys("down")
	wantAll(t, h.view(), "memory notes.md", "path 4     /Users/dev/x", "missing here")
	...
	wantAll(t, h.view(), "notes.md:4: /Users/dev/x", "notes.md:4: /Users/dev/y", "@ref MEMORY.md:2: @~/notes.md", shortPath(dir))
	h.keys("esc")
	if h.a.top() != nil {
